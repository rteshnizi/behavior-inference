...
# Polygon Aliases
MapPolygon: TypeAlias = MovingPolygon | StaticPolygon
GraphInputPolygon: TypeAlias = MapPolygon | SensingPolygon
GraphPolygon: TypeAlias = SensingPolygon | ShadowPolygon
...
def PolygonFactory(PolyCls: type[_T_Polygon], kwArgs: dict[PolygonFactoryKeys, Any]) -> _T_Polygon:
	assert(
		PolyCls.type == MovingPolygon.type or
		PolyCls.type == SensingPolygon.type or
		PolyCls.type == ShadowPolygon.type or
