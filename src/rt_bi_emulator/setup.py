...
setup(
	...
	entry_points={
		"console_scripts": [
			...
			"IMP = rt_bi_emulator.Renderers.MapServiceInterface:main",
			"ISE = rt_bi_emulator.Renderers.SensorTopicInterface:main",
			"ISY = rt_bi_emulator.Renderers.SymbolTopicInterface:main",
			"ITG = rt_bi_emulator.Renderers.TargetTopicInterface:main",
